...
/*                                                            */
/*   Build date: 2019-11-07 16:29:23                          */
...
export interface IHardware {
     ...
     * @readonly
     */
    actual_bootloader?: IShortReference;
    /**
     ...
     * @type IHardwareBootloaderSettings
     * @readonly
     */
    bootloader_core_configuration?: IHardwareBootloaderSettings;
    /**
     * @name bootloader_update_in_progress
     * @type IShortReference
     * @readonly
     */
    bootloader_update_in_progress?: IShortReference;
    /**
     * @name cellular
     * @type IShortReference
     * @readonly
     */
    cellular?: IShortReference;
    /**
     * @name collision
     ...
     * @required
     */
    hardware_group: IShortReference;
    /**
     * @name hardware_type
     * @type IShortReference
     */
...
export interface IHardwareUpdate {
     ...
     * @readonly
     */
    instance_snapshot?: IShortReference;
    /**
     * @name planned
     * @type number
     * @description UNIX time
     ...
     * @readonly
     */
    release_update?: IShortReference;
    /**
     * @name state
     * @type ("PENDING"|"RUNNING"|"COMPLETE"|"CANCELED"|"OBSOLETE"|"FAILED")
     * @required
...
/**
 * @name IHardwareBootloaderSettings
 * @description: Object represent Individual bootloader settings, every value are added automatically. There are factory default settings. Each value has a pending flag. We know 3 types, boolean, integer, string
 */
export interface IHardwareBootloaderSettings {
    /**
     * @name alias
     * @type string
     * @readonly
    ...
    autojump: number;
    /**
     * @name backup_mqtt_connection
     * @type string
     * @readonly
     * @required
     */
    backup_mqtt_connection: string;
    /**
     * @name blreport
     * @type boolean
     * @readonly
    ...
    netsource: string;
    /**
     * @name normal_mqtt_connection
     * @type string
     * @readonly
     * @required
     */
    normal_mqtt_connection: string;
    /**
     * @name pending
     * @type string[]
     * @required
...
export interface ILibraryVersion {
     ...
     * @required
     */
    c_program_examples: IShortReference[];
    /**
     * @name created
     * @type number
     * @example 1466163478
...
export abstract class TyrionAPI {
    ...
    public articleGetListByFilter(page_number:number, body:IArticleFilter):Promise<IArticleList> {
        return this.requestRestPath("PUT", `/article/list/${page_number}`, body, [200], 'application/json');
    }
    ...
    public bProgramGetListByFilter(page_number:number, body:IBProgramFilter):Promise<IBProgramList> {
        return this.requestRestPath("PUT", `/b_program/list/${page_number}`, body, [200], 'application/json');
    }
    ...
    public blockGetListByFilter(page_number:number, body:IBlockFilter):Promise<IBlockList> {
        return this.requestRestPath("PUT", `/block/list/${page_number}`, body, [200], 'application/json');
    }
     ...
     * @tags Admin-Block
     *
     * @description Administration Byzance only - set Version as Main - First code in program
     *
     * @param {string} version_id
     *
     * @returns {IResultOk} [code 200] Ok Result
    ...
    public boardsGetListByFilter(page_number:number, body:IBoardFilter):Promise<IHardwareList> {
        return this.requestRestPath("PUT", `/hardware/filter/${page_number}`, body, [200], 'application/json');
    }
    ...
    public cProgramGetListByFilter(page_number:number, body:ICProgramFilter):Promise<ICProgramList> {
        return this.requestRestPath("PUT", `/c_program/filter/${page_number}`, body, [200], 'application/json');
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public compilationLibraryGetListByFilter(page_number:number, body:ICompilationLibraryFilter):Promise<ICompilationLibraryList> {
        return this.requestRestPath("PUT", `/compilation_library/filter/${page_number}`, body, [200], 'application/json');
    }
    ...
    public gridProjectGetByFilter(page_number:number, body:IGridProjectFilter):Promise<IGridProjectList> {
        return this.requestRestPath("PUT", `/grid_project/filter/${page_number}`, body, [200], 'application/json');
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public hardwareGetStates(page_number:number, body:IHardwareOnlineStatesFilter):Promise<IHardwareNetworkStatesList> {
        return this.requestRestPath("PUT", `/hardware/online_states/${page_number}`, body, [200], 'application/json');
    }
    ...
    public hardwareGroupGetListByFilter(page_number:number, body:IHardwareGroupFilter):Promise<IHardwareGroupList> {
        return this.requestRestPath("PUT", `/hardware_group/filter/${page_number}`, body, [200], 'application/json');
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public hardwareReleaseUpdateGetByFilter(page_number:number, body:IHardwareReleaseUpdateFilter):Promise<IHardwareReleaseUpdateList> {
        return this.requestRestPath("PUT", `/release_update/filter/${page_number}`, body, [200], 'application/json');
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public hardwareUpdateGetByFilter(page_number:number, body:IHardwareUpdatesFilter):Promise<IHardwareUpdateList> {
        return this.requestRestPath("PUT", `/update_task/filter/${page_number}`, body, [200], 'application/json');
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public homerServersGetListByFilter(page_number:number, body:IHomerServerFilter):Promise<IHomerServerList> {
        return this.requestRestPath("PUT", `/homer_server/${page_number}`, body, [200], 'application/json');
    }
    ...
    public instanceGetByFilter(page_number:number, body:IInstanceFilter):Promise<IInstanceList> {
        return this.requestRestPath("PUT", `/instance/filter/${page_number}`, body, [200], 'application/json');
    }
    ...
    public instanceTag(body:ITags):Promise<IInstance> {
        return this.requestRestPath("PUT", `/instance/tags/add`, body, [200], 'application/json');
    }
    ...
    public instanceUntag(body:ITags):Promise<IInstance> {
        return this.requestRestPath("PUT", `/instance/tags/remove`, body, [200], 'application/json');
    }
    ...
    public libraryGetListByFilter(page_number:number, body:ILibraryFilter):Promise<ILibraryList> {
        return this.requestRestPath("PUT", `/library/filter/${page_number}`, body, [200], 'application/json');
    }
    ...
    public libraryTag(body:ITags):Promise<ILibrary> {
        return this.requestRestPath("PUT", `/library/tags/add`, body, [200], 'application/json');
    }
    ...
    public libraryUntag(body:ITags):Promise<ILibrary> {
        return this.requestRestPath("PUT", `/library/tags/remove`, body, [200], 'application/json');
    }
    ...
    public notificationGetLatest(page_number:number):Promise<INotificationList> {
        return this.requestRestPath("GET", `/notification/list/${page_number}`, {}, [200], 'application/json');
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public notificationGetUnread(page_number:number):Promise<INotificationList> {
        return this.requestRestPath("GET", `/notification/unread_list/${page_number}`, {}, [200], 'application/json');
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public projectsGetListByFilter(page_number:number, body:IProjectFilter):Promise<IProjectList> {
        return this.requestRestPath("PUT", `/project/filter/${page_number}`, body, [200], 'application/json');
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public roleGetListByFilter(page_number:number, body:IRoleFilter):Promise<IRoleList> {
        return this.requestRestPath("PUT", `/role/list/${page_number}`, body, [200], 'application/json');
    }
     ...
     * @throws {IResultInternalServerError} [code 500] Server side Error
     */
    public simGetCrdRecords(page_number:number, body:IGSMCRDFilter):Promise<IGSMCDRList> {
        return this.requestRestPath("PUT", `/gsm/cdrs/${page_number}`, body, [200], 'application/json');
    }
    ...
    public simGetDataUsage(body:IDataConsumptionFilter):Promise<IDataByMsisdn[]> {
        return this.requestRestPath("PUT", `/gsm/data_consuption`, body, [200], 'application/json');
    }
    ...
    public simGetListByFilter(page_number:number, body:IGSMFilter):Promise<IGSMList> {
        return this.requestRestPath("PUT", `/gsm/filter/${page_number}`, body, [200], 'application/json');
    }
    ...
    public widgetGetListByFilter(page_number:number, body:IGridWidgetFilter):Promise<IGridWidgetList> {
        return this.requestRestPath("PUT", `/widget/list/${page_number}`, body, [200], 'application/json');
    }
